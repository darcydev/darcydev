...
export const experiments: IExperiments[] = [
	{
		title: 'Journey into Deep Work',
		description: 'Aliqua non fugiat laborum cupidatat esse.',
		link: 'https://mrdarcyprice.medium.com/journey-into-deep-work-3b6fd25c72fd',
		tags: ['Productivity'],
		date: 'Oct, 2019',
		location: 'medium',
	},
